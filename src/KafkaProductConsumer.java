...
public class KafkaProductConsumer {
    public static void main(String[] args) {
        ...
        consumer.subscribe(Arrays.asList("ProductDb"));
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                String getDate = String.valueOf((jsonObject.getString("mfg_date")));
                ...
                try {
                    ...
                    conn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/shoppingCart", "root", "");
                    System.out.println("connection created");
                    stmt = (Statement) conn.createStatement();
                    String query= "INSERT INTO `products`(`model`, `release_year`, `brand`, `price`, `seller_name`, `color`, `mfg_date`) VALUES ('" + getModelName + "'," + getReleaseYear + ",'"+getBrand+"',"+getPrice+",'"+getSellerName+"','"+getColors+"','"+getDate+"')";
